...
export class TestingTableComponent implements OnInit {
  ...
  TableList(){
    this.loading = true;
    this.masterService.getAllTestingTable()
    .subscribe(
      data =>{
        this.loading = false;
  ...
  create(){
    ...
    this.loading = true;
    this.masterService.createTestingTable(this.addForm.value)
    .subscribe(
      data =>{
        this.loading = false;
  ...
  update(){
    ...
    this.loading = true;
    this.masterService.updateTestingTable(this.editForm.value)
    .subscribe(
      data =>{
        this.submitted = false;
        this.loading = false;
  ...
  deleteItem(id){
    this.masterService.deleteTestingTable(id)
    .subscribe(
      data =>{
