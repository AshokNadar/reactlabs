...
export class RequirementComponent implements OnInit {
  ...
  allList(){
    this.loading = true;
    this.masterService.getAllRequirements()
    .subscribe(
      data =>{
        this.loading = false;
  ...
  create(){
    ...
    this.loading = true;
    this.masterService.createRequirements(this.addForm.value)
    .subscribe(
      data =>{
        this.loading = false;
  ...
  update(){
    ...
    this.loading = true;
    this.masterService.updateRequirements(this.editForm.value)
    .subscribe(
      data =>{
        this.submitted = false;
        this.loading = false;
  ...
  deleteItem(id){
    this.masterService.deleteRequirements(id)
    .subscribe(
      data =>{
