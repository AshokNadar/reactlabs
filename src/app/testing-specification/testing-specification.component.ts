...
@Component({
  selector: 'app-testing-specification',
  templateUrl: './testing-specification.component.html',
  styleUrls: ['./testing-specification.component.css']
})
export class TestingSpecificationComponent implements OnInit {
  ...
  allList(){
    this.loading = true;
    this.masterService.getAllTestingSpecification()
    .subscribe(
      data =>{
        this.loading = false;
  ...
  create(){
    ...
    this.loading = true;
    this.masterService.createTestingSpecification(this.addForm.value)
    .subscribe(
      data =>{
        this.loading = false;
  ...
  update(){
    ...
    this.loading = true;
    this.masterService.updateTestingSpecification(this.editForm.value)
    .subscribe(
      data =>{
        this.submitted = false;
        this.loading = false;
  ...
  deleteItem(id){
    this.masterService.deleteTestingSpecification(id)
    .subscribe(
      data =>{
